...
class Command(BaseCommand):
    help = "Print a detailed JSON report of configured databases, tables, columns, constraints, indexes, row counts, and model mapping. Read-only."

    def add_arguments(self, parser):
        parser.add_argument("--indent", type=int, default=2, help="JSON indent (default: 2)")

    def handle(self, *args, **options):
        report: dict[str, object] = {"databases": {}}
